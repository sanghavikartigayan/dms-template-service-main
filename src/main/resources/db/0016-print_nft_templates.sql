insert into dmstemplate.template (template_id, process_id, template_name, template_type, approved_by, modified_by,
                                  ...
                                  created_on)
values ('6ffd6a5a-198e-11ed-861d-0242ac120019', 'NFT', 'Print_nft_english', 'HTML', '', 'dms_template',
        current_timestamp,
        '[
  {
      "defaultValue": "",
  ...
  {
      "defaultValue": "",
      "fieldName": "eligible_participation_date",
      "fieldType": "STRING",
      "isRequired": true
  },
  {
      "defaultValue": "",
      "fieldName": "membership_form_submission_date",
      "fieldType": "STRING",
      "isRequired": true
  },
  {
      "defaultValue": "",
      "fieldName": "possibleEarlyEnrolmentFlag",
      "fieldType": "BOOLEAN",
      "isRequired": true
  },
  {
      "defaultValue": "",
      "fieldName": "nftMatchFlag",
      "fieldType": "BOOLEAN",
      "isRequired": true
  },
  {
      "defaultValue": "",
      "fieldName": "activeMemberMatchFlag",
      "fieldType": "BOOLEAN",
      "isRequired": true
  },
  {
      "defaultValue": "",
      "fieldName": "deferredMemberMatchFlag",
      "fieldType": "BOOLEAN",
      "isRequired": true
  }
...
insert into dmstemplate.template (template_id, process_id, template_name, template_type, approved_by, modified_by,
                                  modified_on, template_fields, template_data, is_active, version, created_by,
                                  created_on)
values ('6ffd6a5a-198e-11ed-861d-0242ac120020', 'NFT', 'Print_nft_french', 'HTML', '', 'dms_template',
        current_timestamp,
        '[
  {
      "defaultValue": "",
